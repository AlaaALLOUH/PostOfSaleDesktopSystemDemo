...
namespace POSDemo.DB {
    ...
    public partial class POSTutDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string name, string code, decimal price, int quantity, string note, string image) {
...
namespace POSDemo.DB.POSTutDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_code = 1 AND [code] IS NULL) OR ([code] = @Original_code)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([name], [code], [price], [quantity], [note], [image" +
                "]) VALUES (@name, @code, @price, @quantity, @note, @image);\r\nSELECT id, name, co" +
                "de, price, quantity, note, image FROM Products WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [name] = @name, [code] = @code, [price] = @price, [quantity] = @quantity, [note] = @note, [image] = @image WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_code = 1 AND [code] IS NULL) OR ([code] = @Original_code)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Original_quantity)));
SELECT id, name, code, price, quantity, note, image FROM Products WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, code, price, quantity, note, image FROM dbo.Products";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_code, global::System.Nullable<decimal> Original_price, global::System.Nullable<int> Original_quantity) {
        ...
        public virtual int Insert(string name, string code, global::System.Nullable<decimal> price, global::System.Nullable<int> quantity, string note, string image) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string code, global::System.Nullable<decimal> price, global::System.Nullable<int> quantity, string note, string image, int Original_id, string Original_name, string Original_code, global::System.Nullable<decimal> Original_price, global::System.Nullable<int> Original_quantity, int id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string code, global::System.Nullable<decimal> price, global::System.Nullable<int> quantity, string note, string image, int Original_id, string Original_name, string Original_code, global::System.Nullable<decimal> Original_price, global::System.Nullable<int> Original_quantity) {
            return this.Update(name, code, price, quantity, note, image, Original_id, Original_name, Original_code, Original_price, Original_quantity, Original_id);
        }
    }
